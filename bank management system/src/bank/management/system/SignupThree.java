...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        // in setBounds(distance from left,height from top,length of text,height of text)
        ...
        services.setBounds(100,420,300,20);
        add(services);
        
        c1 = new JCheckBox("ATM CARD");
        c1.setBackground(Color.WHITE);
        c1.setFont(new Font("Raleway",Font.BOLD,16));
        c1.setBounds(100,470,250,20);
        add(c1);
        ...
        c4.setBounds(350,520,300,20);
        add(c4);
        
        c5 = new JCheckBox("Cheque Book");
        c5.setBackground(Color.WHITE);
        c5.setFont(new Font("Raleway",Font.BOLD,16));
        c5.setBounds(100,570,250,20);
        add(c5);
        
        c6 = new JCheckBox("E statement");
        c6.setBackground(Color.WHITE);
        c6.setFont(new Font("Raleway",Font.BOLD,16));
        c6.setBounds(350,570,300,20);
        add(c6);
        ...
        submit.setBounds(200,690,150,30);
